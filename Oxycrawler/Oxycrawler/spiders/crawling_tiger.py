...
class tScrape(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        # [REINSTATE]plain_text = [text.replace('\n','').replace('\t','').replace('\r','').replace('\xa0','').replace('.tb-megamenu.animate .mega > .mega-dropdown-menu, .tb-megamenu.animate.slide .mega > .mega-dropdown-menu > div {     transition-delay: 100ms;  -webkit-transition-delay: 100ms;  -ms-transition-delay: 100ms;  -o-transition-delay: 100ms;  transition-duration: 250ms;  -webkit-transition-duration: 250ms;  -ms-transition-duration: 250ms;  -o-transition-duration: 250ms;   } ','').replace("Skip to main content                                                                                                                                                                                                                                                                                                                                                                                                                 Utility Menu                                                                      Alumni                                                     Athletics                                                     Giving                                                     Parents & Families                                                     Arts                                                     News                                                     Calendar                                                       Slide-in Utility Nav                                                                      Search                                                     Menu                                                                                            Mega Menu Collapse/Open Button                                                About Oxy                                                                                          Oxy Stories                                               Outcomes                                               Our Campus                                               Los Angeles                                               Equity & Justice                                               Sustainability                                               Community Engagement                                               Strategic Planning                                                                                  Admissions & Aid                                                                                          Apply                                               Costs & Financial Aid                                               College Viewbook                                               Visit Campus                                               Learn About Oxy                                               Transfer Students                                               Int'l Students                                               Student Voices Blog                                               Connect With Us                                                                                  Academics                                                                                          Areas of Study                                               Library                                               Faculty                                               Core Program                                               Senior Comps                                               Student Research                                               Global Engagement                                               Anderson Center                                               Student Success                                                                                  Student Life                                                                                          Housing                                               Campus Dining                                               Athletics & Wellness                                               Career Exploration                                               Get Involved                                               Student Services                                               Resources & Support                                               Student Affairs                                                                                            Search                                                                                                                                                                                                                                                                                                                               Faculty                                                                                   Home                                                 Academics                                                 Areas of Study                                                 Latino/a & Latin American Studies                                                Faculty",'') for text in plain_text]
        # print(plain_text)
